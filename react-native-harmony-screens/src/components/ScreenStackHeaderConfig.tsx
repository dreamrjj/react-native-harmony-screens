...
// Native components
import ScreenStackHeaderConfigNativeComponent from '../specs/ScreenStackHeaderConfigNativeComponent';
import ScreenStackHeaderSubviewNativeComponent, {
  type NativeProps as ScreenStackHeaderSubviewNativeProps,
} from '../specs/ScreenStackHeaderSubviewNativeComponent';
...
export const ScreenStackHeaderCenterView = (props: ViewProps): React.ReactElement => {
  const { style, ...rest } = props;
